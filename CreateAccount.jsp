...
<section class="main">
	<div class="layer">
		...
		<div class="bottom-grid">
			...
			<div class="logo">
				<h1 align="center"> <a href="">Create New Library Membership Account  </a></h1>
			</div>
		...
		<div class="content-w3ls">
			...
			<div class="content-bottom">
				<form action="./AddMember" method="post">
					...
					<div class="field-group">
						<div class="wthree-field">
							<input name="nic" id="text3" type="text" value="" placeholder="NIC (username)"  required>	
						</div>
					</div>
					
					<div class="field-group">
						<div class="wthree-field">
							<input name="mob_num" id="text4" type="text" value="" placeholder="Mobile Number" required>	
						</div>
					</div>
					
					<div class="field-group">
						<div class="wthree-field">
							<input name="email" id="text5" type="text" value="" placeholder="Email" required>	
						</div>
					</div>
					
					<div class="field-group">
						<div class="wthree-field">
							<input name="address" id="text6" type="text" value="" placeholder="Postal Address" required>	
						</div>
					</div>
