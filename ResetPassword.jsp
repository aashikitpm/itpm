				...
				<form action="./ResetPassword" method="post">
					...
					<div class="field-group">
						<div class="wthree-field">
							<input name="oldpass" id="myInput1" type="Password" placeholder="Old Password"  required>
						</div>
					</div>
					...
					<div class="field-group">
						<div class="wthree-field">
							<input name="pass1" id="myInput1" type="Password" placeholder="New Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
						</div>
					</div>
