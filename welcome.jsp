...
<section class="main">
	<div class="layer">
		...
		<div class="bottom-grid">
			<div class="logo">
				<h1> <a href="index.html"><span class=""></span>ARD Library Management System  </a></h1>
			</div>
			<div class="links">
				...
				<form action="./Login" method="post">
					<div class="field-group">
						...
						<div class="wthree-field">
							<input name="uname" id="text1" type="text" value="" placeholder="Username (NIC)" required>
						</div>
					</div>
					<div class="field-group">
					...
					<ul class="list-login">
						...
						<li>
							<a href="#" class="text-right">Reset password?</a>
						</li>
						<li class="clearfix"></li>
					</ul>
					<div class="wthree-field">
						<button type="submit" class="btn">Crate account</button>
					</div>
